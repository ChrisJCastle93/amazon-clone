...
// In this, the DOM Selector gets us the # i and following characters from our URL. we then split that by the slash, to create an array. We turn this array into an object that outlines the resource, id, action.
